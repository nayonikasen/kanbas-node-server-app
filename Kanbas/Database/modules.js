        ...
        "lessons": [
            {
                ...
                "description": "Introduction to aerodynamics and airfoil theory.",
                "module": "M201"
            },
            {
                "_id": "L402",
                "name": "Fluid Dynamics",
                "description": "Understanding the flow of fluids around objects.",
                "module": "M201"
            },
            {
                "_id": "L403",
                "name": "Lift and Drag",
                "description": "Exploring the forces of lift and drag in flight.",
                "module": "M201"
            }
        ]
    },
        ...
        "lessons": [
            {
                "_id": "L501",
                "name": "Subsonic Flow",
                "description": "Explaining the characteristics of subsonic flow.",
                "module": "M202"
            },
            {
                "_id": "L502",
                "name": "Supersonic Flow",
                "description": "Understanding the behavior of airflows at supersonic speeds.",
                "module": "M202"
            },
            {
                "_id": "L503",
                "name": "Shock Waves",
                "description": "Exploring shock waves in supersonic flow.",
                "module": "M202"
            }
        ]
    },
        ...
        "lessons": [
            {
                ...
                "description": "Understanding the fundamentals of aerodynamic heating.",
                "module": "M203"
            },
            {
                "_id": "L602",
                "name": "Thermal Protection Systems",
                "description": "Designing systems to protect spacecraft from aerodynamic heating.",
                "module": "M203"
            },
            {
                "_id": "L603",
                "name": "Reentry Heating",
                "description": "Understanding the heating effects on spacecraft during reentry.",
                "module": "M203"
            }
        ]
    },
        ...
        "lessons": [
            {
                ...
                "description": "Choosing materials for spacecraft structural components.",
                "module": "M301"
            },
            {
                "_id": "L702",
            ...
            },
            {
                ...
                "description": "Manufacturing techniques for spacecraft structures.",
                "module": "M301"
            }
        ]
    },
        ...
        "lessons": [
            {
                ...
                "description": "Introduction to orbital motion and Kepler's laws.",
                "module": "M302"
            },
            {
                "_id": "L802",
                "name": "Orbit Transfers",
                "description": "Understanding methods of changing spacecraft orbits.",
                "module": "M302"
            },
            {
                "_id": "L803",
        ...
        "lessons": [
            {
                ...
                "description": "Designing spacecraft subsystems, including power and communications.",
                "module": "M303"
            },
            {
                "_id": "L902",
                "name": "System Integration",
                "description": "Integrating spacecraft subsystems into a cohesive system.",
                "module": "M303"
            },
            {
                "_id": "L903",
                "name": "Testing and Validation",
                "description": "Testing spacecraft systems for reliability and performance.",
                "module": "M303"
            }
        ]
    }
